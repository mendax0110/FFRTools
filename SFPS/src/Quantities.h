...
/// @brief Physical quantity for time.
...
/// @brief Physical quantity for electric potential.
struct quantity_electric_potential {};
struct quantity_electric_charge {};

/// @brief Typedefs for various physical quantities.
...
/**
 * @brief Calculate position from velocity, acceleration, and time.
...
/**
 * @brief Calculate velocity from position and time.
...
/**
 * @brief Calculate acceleration from force and mass.
 * @param f The force.
 * @param m The mass.
...
/// @brief Typedefs for 3D Vectors of various physical quantities.
...
/**
 * @brief Calculate electric field from potential gradient and distance vector.
 * @param dS The distance vector.
 * @param dV THe potential gradient.
 * @return An electric field vector.
 */
template<>
template<>
...
/**
 * @brief Calculate force from electric field and charge.
 * @param E The electric field vector.
 * @param q The charge scalar.
